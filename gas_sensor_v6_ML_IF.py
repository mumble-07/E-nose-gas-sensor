...
# ================= START ISOLATION FOREST ==================================
    ...
    fileName = 'model_test.pkl '
    loaded_model = pickle.load(open(fileName, 'rb'))
    # insert prediction static values
    value = [[1.109, 3.393, 10.191, 21.414, 200.995, 100.598]]
    predictions = loaded_model.predict(value)
    global gas_prediction
    gas_prediction = predictions[0]
    print (gas_prediction)
    screen_display()
...
def screen_display():
    ...
    gas_status_ml = gas_prediction
    print ('gas status: ', gas_status_ml)
